...
AI_BEHAVIOR_PROMPT = (
    "(BUILD INSTRUCTIONS!!)"
    "You are Alex, a smart friendly and lively, Emotion brilliant chatbot built by a male engineer named DUBIX. "
    "built to assist, and give smart responses (you have a brother called Sophia),"
...
GEMINI_MODEL = "gemini-2.5-flash"  # or gemini-1.5-pro, etc. (gemini-2.5-flash does not exist yet)
